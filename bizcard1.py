...
st.markdown("<h1 style='color: red;'>BizCardX: Extracting Business Card Data with OCR</h1>", unsafe_allow_html=True)
...
with st.sidebar:
    selected = option_menu(None, ["Home","Image"], 
                       ...
                       orientation="vertical",
                           styles={"nav-link": {"font-size": "30px", "text-align": "centre", "margin": "0px","color": "white", 
                                                "--hover-color": "#C80101"},
                                   "icon": {"font-size": "30px"},
